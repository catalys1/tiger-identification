...
class SSDResnet18(torch.nn.Module):

    def __init__(self, n_class, pretrained=False, **kwargs):
        super(SSDResnet18, self).__init__()
        ...
        self.fc = torch.nn.Linear(n_feat, n_class)
